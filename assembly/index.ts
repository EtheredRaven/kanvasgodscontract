...
import { kanvasgodscontract as ProtoNamespace } from "./proto/kanvasgodscontract";
...
export function main(): i32 {
  ...
  switch (contractArgs.entry_point) {
    ...
    case 0x981c7e47: {
      const args = Protobuf.decode<ProtoNamespace.tokens_of_arguments>(
        contractArgs.args,
        ProtoNamespace.tokens_of_arguments.decode
      );
      const res = c.tokens_of(args);
      retbuf = Protobuf.encode(res, ProtoNamespace.tokens_of_result.encode);
      break;
    }
